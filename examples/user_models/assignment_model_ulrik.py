    ...
    return {
        ...
        'generators': {
            'GEN': [
                ...
                ['G1',      'B1',   50,       10,    41.8,    0.933,       6.5,         0,     1.05,   0.66,    0.3,      0.66,      0.23,       0.23,        8.0,        1,          0.03,       0.07],
                ['IB',      'B3',   1e10,    245,   0,  0.898,       3.5e7,         0,      1.8,    1.8,    0.3,      0.65,      0.23,       0.23,        8.0,        1,          0.03,       0.07],
            ], #IB er stiff grid, nominell ikke pu (n)
        }
    }