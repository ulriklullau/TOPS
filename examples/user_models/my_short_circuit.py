...
if __name__ == '__main__':
    ...
    # Load model
    import user_lib.sm_ib as model_data
    ...
    sc_bus_idx = ps.gen['GEN'].bus_idx_red['terminal'][0] # Change the last number for another generator
    ...
    while t < t_end:
        ...
        res['p'].append(ps.gen['GEN'].p_e(x, v).copy())
